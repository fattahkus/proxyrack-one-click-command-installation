...
container_build(){
  ...
  # sleep 60
    curl -X POST https://peer.proxyrack.com/api/device/add -H 'Api-Key: RA13PVOJSVKD7LDYIT1SAYHXMTC6N5WOWZEZWWFM' -H 'Content-Type: application/json' -d '{"device_id":"'$dvid'","device_name":"'$dname'"}'
