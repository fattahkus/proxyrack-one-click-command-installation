...
container_build(){
  ...
  device_name=$dname
  # sleep 60
    curl -X POST https://peer.proxyrack.com/api/device/add -H 'Api-Key: RA13PVOJSVKD7LDYIT1SAYHXMTC6N5WOWZEZWWFM' -H 'Content-Type: application/json' -H 'Accept: application/json' -d "{'device_id':'$device_id','device_name':'$device_name'}"
